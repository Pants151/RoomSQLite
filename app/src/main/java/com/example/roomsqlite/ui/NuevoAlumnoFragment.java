 ...
 * Use the {@link NuevoAlumnoFragment#newInstance} factory method to
...
public class NuevoAlumnoFragment extends Fragment {
    ...
    public static NuevoAlumnoFragment newInstance(String param1, String param2) {
        NuevoAlumnoFragment fragment = new NuevoAlumnoFragment();
